        ...
        <section id="process" className="bg-background mt-20">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <Badge variant="outline" className="mt-4 text-primary border-primary/20">
            ...
            <div className="text-center mt-12">
                <p className="text-muted-foreground">No necesitas datos bancarios para empezar. Configurá MercadoPago cuando estés listo.</p>
            </div>
        </section>
    )
}
